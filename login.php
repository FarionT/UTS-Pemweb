    ...
    <div class="d-flex justify-content-around">
        <div class="d-flex justify-content-around body-login mt-5">
            <div class=" login-description" data-aos="zoom-in"data-aos-duration="1000" >
                ...
                <p >Ngoding coy merupakan website yang dikembangkan sebagai forum bagi para programmer                
            ...
            <div class="d-flex flex-column align-items-center p-5 login-form " data-aos="zoom-in"data-aos-duration="1000" style=" background-color: #F2F2F2; border: 1px solid #FFB800;border-bottom: 5px solid #FFB800; border-right: 5px solid #FFB800; border-radius: 15px;">
